 ...
 * the upload fails
 */
Storj.prototype.createFile = function(bucket, fileName, opts, callback) {
  var files = [];
  var first = files[0];
...
Storj.prototype._storeFileInBucket = function(callback) {
 ...
 * errors occurs
 */
Storj.prototype.getFile = function(bucketId, fileName, callback) {
 ...
 * an error occurs
 */
Storj.prototype.getFiles = function(bucketId, callback) {
 ...
 * occurs
 */
Storj.prototype.deleteFile = function(bucketId, fileId, callback) {
  client.removeFileFromBucket(bucketId, fileId, function(err, file){
